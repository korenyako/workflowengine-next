...
description: >-
  At first sight, state machines seem to be an easy tool for developers.
  Nonetheless, developers soon start to regret using them. Read to find out why.
...
author:
  name: Optimajet Team
---
![Why Developers Never Use State Machines](/images/blog/why-developers-never-use-state-machines/machines.jpg)
