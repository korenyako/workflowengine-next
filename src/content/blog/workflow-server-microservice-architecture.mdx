...
description: >-
  Our clients asked us many times how to quickly integrate Workflow Engine into
  their architecture. Now we have a special product for such scenarios—Workflow
  Server.
...
author:
  name: Optimajet Team
---
![Workflow Server—a microservice architecture component](/images/blog/workflow-server-microservice-architecture/server.jpg)
