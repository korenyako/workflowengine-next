...
interface CenteredCodeBlockProps {
  title: string;
  subtitle?: string;
  description: string;
  code: string;
  language: 'bash' | 'javascript' | 'tsx' | 'json' | 'typescript' | 'jsx';
  tabs?: Tab[];
  primaryCta?: {
    text: string;
    href: string;
...
const CenteredCodeBlock: React.FC<CenteredCodeBlockProps> = ({
  title,
  subtitle,
  description,
  code,
  ...
  return (
    <section className="py-8 lg:py-16 px-4 sm:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Описание */}
        <p 
          className={`text-lg lg:text-xl mb-8 lg:mb-16 leading-normal ${textColor} whitespace-pre-wrap break-words`}
...
export default CenteredCodeBlock; 
