...
interface LlmSettingsIconProps {
  size?: number;
  className?: string;
}

const LlmSettingsIcon: React.FC<LlmSettingsIconProps> = ({ size = 24, className }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 14 14"
