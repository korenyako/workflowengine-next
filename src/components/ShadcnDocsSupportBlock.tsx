...
const ShadcnDocsSupportBlock: React.FC = () => {
  return (
    <section className="text-white py-10 pb-16 px-4 sm:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="article-content space-y-5 font-[Space_Grotesk] text-lg lg:text-xl leading-8 text-left">
          ...
          <List
            items={[
              <><a href="https://workflowengine.io/documentation/components-library/shadcn-ui/" className="text-blue-300 hover:text-blue-200 transition-colors">WorkflowEngine shadcn/ui Components Documentation</a></>,
              ...
              <><a href="https://ui.shadcn.com/" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 transition-colors">shadcn/ui Documentation</a></>,
            ]}
          />
...
export default ShadcnDocsSupportBlock;
