    ...
    <section className="text-slate-900 py-10 pb-16 px-4 sm:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="article-content space-y-5 font-[Space_Grotesk] text-lg lg:text-xl leading-8 text-left">
          ...
          <List
            items={[
              <><a href="https://workflowengine.io/documentation/components-library/material-ui/" className="text-blue-600 hover:text-blue-700 transition-colors">WorkflowEngine MUI Components Documentation</a></>,
              ...
              <><a href="https://mui.com/material-ui/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 transition-colors">Material UI Documentation</a></>,
            ]}
          />
