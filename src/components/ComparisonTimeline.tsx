      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-0">
                ...
                <h3 className="text-white text-lg font-subtitle font-semibold tracking-wide">In-house Development</h3>
              <p className="text-lg lg:text-xl leading-normal text-gray-300">~9 months / ~$150,000</p>
            </div>
            <div className="grid grid-cols-9 gap-1">
              {inHouseStages.map((stage, index) => (
                                  <div
                    key={index}
                    className="bg-gray-800 rounded-lg p-2 sm:p-3 flex flex-col justify-center h-32"
                    style={{
                  ...
                  <div className="text-white text-base sm:text-lg font-normal mt-1">
                    {stage.cost}
                  </div>
                  <div className="text-white text-sm font-normal mt-1">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-0">
            ...
            <div className="flex justify-between items-center mt-4">
              <h3 className="text-blue-300 text-lg font-subtitle font-semibold tracking-wide">WorkflowEngine Designer</h3>
              <p className="text-lg lg:text-xl leading-normal text-gray-300">~2 months / from $0</p>
            </div>
          </div>
        </div>
      </div>
